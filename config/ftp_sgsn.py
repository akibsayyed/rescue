"""
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
+ PROGRAM: SGSN CDR file downloader
+
...
+       1.00        01/05/2016    Phuntsho            Correct Logs showing non-download files
...
ftp_src  = "/FulcrumGPRSData/Datadir/CDRFinalBK/"
ftp_dest = "/home/ftpuser/reconcile/data/cdrs/sgsn/parsedfiles"
    ...
    try:
        with ftputil.FTPHost(ftp_host, ftp_usr, ftp_pwd) as node_source:
            ...
            for file_name in file_list:
                if (node_source.path.isfile(file_name)) and ('sgsn' in file_name.lower()) and (node_source.path.getmtime(file_name)>=past):
